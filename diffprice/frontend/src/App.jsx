...
import CheckoutPage from './Components/pages/CustomCheckoutPage'; // Correct path to CheckoutPage
const App = () => {
      ...
      <Router>
        <div className="App">
          ...
          <Routes>
            ...
            <Route path="/" element={<ProductDetails productId="8823165354234" />} />
            ...
            <Route path="/custom-checkout" element={<CheckoutPage />} />
